...
func TestAccApp_normal(t *testing.T) {
...
func testAccCheckAppExists(resOrg, resQuota string) resource.TestCheckFunc {
...
func testAccCheckAppDestroyed(orgname string) resource.TestCheckFunc {
